...
export default function Signup({ csrfToken }) {
  ...
  return (
    <>
      <Head>
        <title>Đăng ký - Font Chữ Wedding</title>
        <meta
          name="description"
          content="Đăng ký tài khoản Font Chữ Wedding để truy cập bộ sưu tập font chữ Việt hóa đẹp cho thiệp cưới, backdrop và decor. Tạo tài khoản miễn phí ngay hôm nay."
        />
        <meta
          name="keywords"
          content="Font Chữ Wedding, font chữ Việt hóa, font thiệp cưới, font wedding, đăng ký, font chữ đẹp, tạo tài khoản"
        />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="robots" content="noindex, nofollow" />
        <meta property="og:title" content="Đăng ký - Font Chữ Wedding" />
        <meta
          property="og:description"
          content="Đăng ký tài khoản Font Chữ Wedding để khám phá bộ sưu tập font chữ Việt hóa đẹp cho thiệp cưới, backdrop và decor."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://font.cuoihoibacninh.com/dang-ky" />
        ...
        <meta name="twitter:title" content="Đăng ký - Font Chữ Wedding" />
        <meta
          name="twitter:description"
          content="Đăng ký tài khoản Font Chữ Wedding để trải nghiệm font chữ Việt hóa đẹp cho thiệp cưới."
        />
        <meta name="twitter:image" content="https://font.cuoihoibacninh.com/logo-font.png" />
        <link rel="icon" href="/favicon.ico" />
        <link rel="canonical" href="https://font.cuoihoibacninh.com/dang-ky" />
        <meta httpEquiv="content-language" content="vi" />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebPage",
            name: "Đăng ký - Font Chữ Wedding",
            description:
              "Đăng ký tài khoản Font Chữ Wedding để truy cập bộ sưu tập font chữ Việt hóa đẹp cho thiệp cưới, backdrop và decor.",
            url: "https://font.cuoihoibacninh.com/dang-ky",
            publisher: {
              "@type": "Organization",
